...
def render_rating_scripts() -> str:
    return '''<link rel="stylesheet" href="/ratings.css?v=20260901-3"><script>window.RECEPTORES_TURNSTILE_SITE_KEY = "0x4AAAAAAEkQy8FIbatMffjR";</script><script src="https://challenges.cloudflare.com/turnstile/v0/api.js" defer></script><script src="/ratings.js?v=20260901-6" defer></script>'''
...
def main():
    ...
    ranking_html = render_ranking_page().replace("ratings.js?v=20260901-" + "4", "ratings.js?v=20260901-6")
