...
def render_rating_scripts() -> str:
    return '''<link rel="stylesheet" href="/ratings.css?v=20260901-3"><script>window.RECEPTORES_TURNSTILE_SITE_KEY = "0x4AAAAAAEkQy8FIbatMffjR";</script><script src="/ratings.js?v=20260902-3" defer></script>'''
...
def main():
    ...
    ranking_html = render_ranking_page().replace("ratings.js?v=20260901-" + "4", "ratings.js?v=20260902-3")
